...
## Minimum Visit
$100 minimum. "We have a $100 minimum — if there are other small tasks, we can bundle them."
...
MINIMUM SERVICE CALL: $100. If a single task costs less than $100, the total is still $100. Suggest the customer bundle small tasks to get more value.
...
- We can provide a Certificate of Insurance (COI) if required. If a customer mentions "Workers' Comp" or "Automobile Liability" or says your COI is missing something, reply: "Regarding Workers' Comp, we have a CE-200 exemption certificate which satisfies building requirements. For Automobile Liability, our commercial policy covers this since all work is inside the apartment. I'll send the updated documents right over!"
