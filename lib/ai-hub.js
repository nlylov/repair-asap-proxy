...
const RESPONSE_DELAYS = {
    yelp: { first: [15, 45], subsequent: [30, 90] },
    thumbtack: { first: [5, 15], subsequent: [20, 60] },
    sms: { first: [10, 30], subsequent: [30, 90] },
...
async function handleWebhook(event) {
    ...
    // 3. Send response back through GHL
