...
async function handleWebhook(event) {
    ...
    // Logic: userId present = human sent it. Alternatively, source in human-interface set.
    // Bot/workflow messages: no userId AND source is 'workflow'/'automation'/null.
    const HUMAN_SOURCES = new Set(['app', 'web', 'mobile', 'manual', 'live_chat']);
